...
<div style="background-color: #7D3C98; color: white; border-radius: 10px; padding: 10px; text-align: center; display: flex; align-items: center; justify-content: center; height: 100%;">
  ...
  <span style="font-size: 1vw; width: 100%;">
    **Want to make a project like this?** This dashboard was inspired by [Melissa Van Bussel](https://www.melissavanbussel.com/) for Posit's Table Contest.<br> You can find her tutorial [here](https://melissavanbussel.github.io/spotify-dashboard) and you can find the code that powers my version of the dashboard [here](https://github.com/econmaett/spotify-dashboard).
  </span>
